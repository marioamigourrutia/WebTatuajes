...
async function requireAdmin(request: Request) {
  try {
    ...
    console.error("Products admin authentication failed", error);
...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error("Products admin list failed", error);
    return NextResponse.json({ error: "No pudimos cargar las obras administrables." }, { status: 500 });
  }
}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("Products admin create failed", error);
    return NextResponse.json({ error: "No pudimos crear la obra." }, { status: 500 });
  }
}
...
export async function PATCH(request: Request) {
  ...
  try {
    ...
    console.error("Products admin update failed", error);
    return NextResponse.json({ error: "No pudimos actualizar la obra." }, { status: 500 });
  }
}
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    console.error("Products admin delete failed", error);
    return NextResponse.json({ error: "No pudimos ocultar la obra." }, { status: 500 });
  }
}
